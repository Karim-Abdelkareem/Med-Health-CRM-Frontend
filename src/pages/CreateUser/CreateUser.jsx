...
import { FiUser, FiMail, FiLock, FiMap, FiUsers } from "react-icons/fi";
...
export default function CreateUser() {
  ...
  useEffect(() => {
    ...
    if (role === "R" && (!formData.LM || !formData.DM || !formData.governate)) {
      setIsFormValid(false);
    } else if (role === "LM" && (!formData.DM || !formData.governate)) {
      setIsFormValid(false);
